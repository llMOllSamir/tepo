        ...
        <Modal isOpen={isModalOpen} onClose={handleClose}>
            ...
            <div className={`md:fixed static top-36 slide-down  right-0 w-96   bg-white dark:bg-gray-700 dark:text-white  shadow-lg transition-all duration-300 rounded-xl  shadow-gray-300 overflow-hidden select-none `}>
                <form onSubmit={handleSubmit(fetchData)} className='flex flex-col gap-5 p-5 py-10 w-full relative ' >
                    ...
                    <p className='text-center text-sm  dark:text-gray-200 font-bold'> Don&apos;t have an account ? <span className='text-red-600 cursor-pointer' onClick={() => { router.replace("/signup"); setModalOpen(false) }}>Register</span></p>
                </form>
            </div>
        </Modal>
